function init1() {
    let t = document.getElementById("tlkio"),
...
function init2() {
    let n = document.getElementById("tlkio"),
    ...
    n.appendChild(a)
    n.appendChild(o)
    window.setTimeout(init1(), 3e3)

}

export function start_tlk() {

    if (window.addEventListener) {
        console.log("if")

        window.addEventListener("load", init2, !1)
    } else {
        console.log("else")
